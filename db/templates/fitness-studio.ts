        ...
        },
        {
          ...
          props: {
            html:
              ...
              "<h3>Marcus Webb — Cycle &amp; Boxing Conditioning Coach</h3><p>A USA Boxing-certified coach and former amateur boxer, Marcus builds the playlists and the punch combos — expect no-nonsense conditioning and a killer sound system.</p>",
            max_width: "medium",
          },
        },
        {
      ...
      blocks: [
        navBar("pricing-nav"),
        {
          ...
          props: {
            ...
            cta_label: "See Membership Options",
            cta_href: "/pricing",
            align: "center",
          },
        },
