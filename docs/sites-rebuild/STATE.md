...
| P12 | Hardening + first real client migration | `2026-06-28-p12-hardening-migration.md` | **in_review** | `feat/sites-p12-hardening-migration` / PR #5 | All 8 tasks implemented. analyticsScriptTag extracted to analytics.ts; Sentry stubs (no dynamic import); CSP via buildCsp(); pg-boss getQueue API; 15 new tests. Pre-existing smoke flake (resolveSite 500 on no-DB) noted in PR body. |
