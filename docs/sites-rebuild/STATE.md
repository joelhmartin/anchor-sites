...
| P12 | Hardening + first real client migration | `2026-06-28-p12-hardening-migration.md` | **ready** | — | Per PLAN.md / D-021 (Plausible/Umami analytics), D-019 pg-boss workers, rate limiting, web-vitals, error tracking, first live client migration. Final phase. |
